...
You can also use [storage classes](https://github.com/blastbao/minio/tree/master/docs/erasure/storage-class) to set custom parity distribution per object.
...
![Distributed MinIO, n nodes with m drives each](https://github.com/blastbao/minio/blob/master/docs/screenshots/Architecture-diagram_distributed_nm.png?raw=true)
